...
It allows search engines to have a better understanding of content and how it should be 
interpreted so that it can be viewed easily. 


2. Name two big differences between ```display: block;``` and ```display: inline;```.

The differences between ```display: block;``` and ```display: inline;``` is "block" takes up
the full width of a new line whereas "inline" only takes up the width of what is needed. 

3. What are the 4 areas of the box model?

The 4 areas of the box model are as follows:
1-content
2-padding
3-border
4-margin
...
While using flexbox, ```align-items: center``` is laid out on the cross-axis. 
